...
.LFB2:
	...
	movaps	%xmm7, 192(%rsp)
.L10:
	.stabn	68,0,60,.LM23-.LFBB3
.LM23:
	movq	%fs:40, %rax
	movq	%rax, 24(%rsp)
	xorl	%eax, %eax
	.stabn	68,0,63,.LM24-.LFBB3
.LM24:
	cmpq	$0, panicstr(%rip)
	je	.L15
	.p2align 4,,10
	.p2align 3
.L12:
	.stabn	68,0,79,.LM25-.LFBB3
.LM25:
	xorl	%edi, %edi
	call	monitor
	jmp	.L12
.L15:
	.stabn	68,0,65,.LM26-.LFBB3
.LM26:
	movq	%rbx, panicstr(%rip)
	.stabn	68,0,68,.LM27-.LFBB3
.LM27:
#APP
# 68 "kern/init.c" 1
	cli; cld
